...
X_train.drop("display_address",axis=1,inplace=True)
X_test.drop("display_address",axis=1,inplace=True)
...
X_train.drop([c for c in X_train.columns if c in columns_to_drop], axis=1,inplace=True)
X_test.drop([c for c in X_test.columns if c in columns_to_drop], axis=1,inplace=True)
